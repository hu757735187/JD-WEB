<template>
  <div class="cc">
                  ...
                  <div class="m succeed-box">
                      <div class="mc success-cont">
                          <div class="success-lcol">
                              ...
                              <div class="p-item">
                                  <div class="p-img">
                                      <a href="javascript:;" target="_blank"><img src="img/shang1.jpg"></a>
                                  </div>
                                  <div class="p-info">
                                      <div class="p-name">
      ...
      <div >
          <img class="img1" src="@/assets/img/cc/1.png" alt="">
      </div>
      <div >
          <img class="img1" src="@/assets/img/cc/2.png" alt="">
      </div>
      <div >
          <img class="img1" src="@/assets/img/cc/3.png" alt="">
      </div>
      <div >
          <img class="img1" src="@/assets/img/cc/4.png" alt="">
      </div>
