<template>
    ...
    <div class="header_head">
        <div class="header_head_box">
            <a href="#" class="img"><img src="@/assets/img/header_nav/logo.jpg" /></a>
            <b class="header_head_p">
                <a href="#">
                    <img src="@/assets/img/header_nav/img_05.png" style="border-radius: 50%;"/>
            ...
            <ul>
                ...
                <li class="header_wdjd">
                    <a href="#">我的京东</a>
                    <img src="@/assets/img/header_nav/1.png" />
                ...
                <li class="header_sjjd">
                    ...
                    <div class="header_sjjd_div">
                        <img src="@/assets/img/header_nav/59a51cafn0fec6121.png" />
                    </div>
                </li>
            </ul>
        </div>
